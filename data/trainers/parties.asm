...
Lyra1Group:
	...
	def_trainer LYRA1_1, "Lira"
	tr_mon 5, "Chicory", CHIKORITA
	end_trainer

	def_trainer LYRA1_2, "Lira"
	tr_mon 5, "Cinder", CYNDAQUIL
	end_trainer

	def_trainer LYRA1_3, "Lira"
	tr_mon 5, "Toto", TOTODILE
	end_trainer

	def_trainer LYRA1_4, "Lira"
	tr_mon 16, PIDGEY
		tr_evs 36 HP, 36 Spe
...
YoungsterGroup:
	...
	def_trainer MIKEY, "Joey"
	tr_mon 2, RATTATA
	tr_mon 4, PIDGEY
	end_trainer

	def_trainer ALBERT, "Mikey"
	tr_mon 8, RATTATA
	tr_mon 10, ZUBAT
	end_trainer

	def_trainer GORDON, "Albert"
	tr_mon 11, WOOPER
	end_trainer

	def_trainer WARREN, "Gordon"
	tr_mon 56, FEAROW
	tr_mon 60, RATICATE
	end_trainer

	def_trainer JIMMY, "Warren"
	tr_mon 60, RATICATE
	tr_mon 60, ARBOK
	tr_mon 60, PARASECT
	end_trainer

	def_trainer OWEN, "Jimmy"
	tr_mon 53, GROWLITHE
	tr_mon 54, GROWLITHE
	end_trainer

	def_trainer JASON, "Owen"
	tr_mon 55, SANDSLASH
	tr_mon 55, CROBAT
	end_trainer

	def_trainer YOUNGSTER_JOSH, "Justin"
	tr_mon 60, RATICATE
	tr_mon 62, GOLBAT
	tr_mon 60, RATICATE
	end_trainer

	def_trainer REGIS, "Josh"
	tr_mon 58, GOLBAT
	tr_mon 58, ELECTRODE
	end_trainer

	def_trainer ALFIE, "Regis"
	tr_mon 54, SANDSLASH
	tr_mon 55, QUAGSIRE
	end_trainer

	def_trainer OLIVER, "Alfie"
	tr_mon 54, GOLBAT
	tr_mon 54, RATICATE
	end_trainer

	def_trainer CHAZ, "Oliver"
	tr_mon 54, SANDSHREW
	tr_mon 55, RATICATE
	end_trainer

	def_trainer TYLER, "Chaz"
	tr_mon LEVEL_FROM_BADGES + 8, WEEPINBELL
	tr_mon LEVEL_FROM_BADGES + 9, QUAGSIRE
	tr_mon LEVEL_FROM_BADGES + 8, SANDSLASH
	end_trainer

	def_trainer ARDEN, "Tyler"
	tr_mon 55, FLAREON
	tr_mon 53, TAUROS
	tr_mon 55, RAPIDASH
	end_trainer
...
BugCatcherGroup:
	...
	def_trainer ARNIE1, "Wade"
	tr_mon 16, VENONAT
	end_trainer

	def_trainer ARNIE2, "Wade"
	tr_mon 20, VENONAT
	end_trainer

	def_trainer ARNIE3, "Wade"
	tr_mon 28, VENOMOTH
		tr_moves DISABLE, SUPERSONIC, CONFUSION, LEECH_LIFE
	end_trainer

	def_trainer ARNIE4, "Wade"
	tr_mon 36, VENOMOTH
		tr_moves GUST, SUPERSONIC, PSYBEAM, LEECH_LIFE
	end_trainer

	def_trainer ARNIE5, "Wade"
	tr_mon 40, VENOMOTH
		tr_moves GUST, SUPERSONIC, PSYCHIC_M, TOXIC
	end_trainer

	def_trainer DON, "Arnie"
	tr_mon 3, CATERPIE
	tr_mon 3, CATERPIE
	end_trainer

	def_trainer BENNY, "Don"
	tr_mon 7, WEEDLE
	tr_mon 10, KAKUNA
	tr_mon 12, BEEDRILL
	end_trainer

	def_trainer AL, "Benny"
	tr_mon 13, CATERPIE
	tr_mon 13, WEEDLE
	end_trainer

	def_trainer JOSH, "Justin"
	tr_mon 12, PARAS
	tr_mon 12, VENONAT
	end_trainer

	def_trainer KEN, "Josh"
	tr_mon 46, ARIADOS
	tr_mon 47, PINSIR
	end_trainer

	def_trainer WAYNE, "Ken"
	tr_mon 9, PARAS
	tr_mon 10, PINECO
	end_trainer

	def_trainer OSCAR, "Wayne"
...
CamperGroup:
	...
	def_trainer TODD1, "Oscar"
	tr_mon 14, PSYDUCK
	end_trainer

	def_trainer TODD2, "Oscar"
	tr_mon 17, GEODUDE
	tr_mon 17, GEODUDE
	tr_mon 23, PSYDUCK
	end_trainer

	def_trainer TODD3, "Oscar"
	tr_mon 23, GEODUDE
	tr_mon 23, GEODUDE
	tr_mon 26, PSYDUCK
	end_trainer

	def_trainer TODD4, "Oscar"
	tr_mon 30, GRAVELER
	tr_mon 30, GRAVELER
	tr_mon 30, SLUGMA
	tr_mon 32, PSYDUCK
	...
	def_trainer ROLAND, "Todd"
	tr_mon 10, NIDORAN_M
	end_trainer

	def_trainer IVAN, "Roland"
	tr_mon 11, DIGLETT
	tr_mon 11, ZUBAT
	tr_mon 15, DIGLETT
	end_trainer

	def_trainer BARRY, "Ivan"
	tr_mon 60, NIDOKING
	end_trainer

	def_trainer LLOYD, "Barry"
	tr_mon 56, NIDOKING
	end_trainer

	def_trainer DEAN, "Lloyd"
	tr_mon 54, GOLDUCK
	tr_mon 52, SANDSLASH
	end_trainer

	def_trainer SID, "Dean"
	tr_mon 53, DUGTRIO
	tr_mon 51, PRIMEAPE
	tr_mon 51, POLIWRATH
	end_trainer
	...
	def_trainer JERRY, "John"
	tr_mon 62, RHYDON
	end_trainer

	def_trainer SPENCER, "Jerry"
	tr_mon 28, SANDSHREW
	tr_mon 29, SANDSLASH
	tr_mon 30, GOLBAT
	end_trainer

	def_trainer QUENTIN, "Spencer"
	tr_mon 30, FEAROW
	tr_mon 30, PRIMEAPE
	tr_mon 30, TAUROS
	end_trainer

	def_trainer GRANT, "Quentin"
	tr_mon LEVEL_FROM_BADGES + 1, SUNFLORA
	tr_mon LEVEL_FROM_BADGES + 1, MARILL
	end_trainer

	def_trainer CRAIG, "Grant"
	tr_mon LEVEL_FROM_BADGES + 5, PIDGEOTTO
	tr_mon LEVEL_FROM_BADGES + 5, MANKEY
	tr_mon LEVEL_FROM_BADGES + 6, SANDSLASH
	end_trainer

	def_trainer FELIX, "Craig"
	tr_mon LEVEL_FROM_BADGES + 8, CHARMELEON
	end_trainer

	def_trainer TANNER, "Felix"
	tr_mon 58, SUDOWOODO
	end_trainer

	def_trainer CLARK, "Tanner"
	tr_mon 56, "Campfire", QUILAVA
	end_trainer

	def_trainer PEDRO, "Clark"
	tr_mon 62, FURRET
	end_trainer

	def_trainer AMOS, "Pedro"
...
PicnickerGroup:
	...
	def_trainer LIZ1, "Amos"
	tr_mon 10, NIDORAN_F
	end_trainer

	def_trainer LIZ2, "Amos"
	tr_mon 15, WEEPINBELL
	tr_mon 15, NIDORINA
	end_trainer

	def_trainer LIZ3, "Amos"
	tr_mon 19, WEEPINBELL
	tr_mon 19, NIDORINO
	tr_mon 21, NIDOQUEEN
	end_trainer

	def_trainer LIZ4, "Amos"
	tr_mon 24, WEEPINBELL
	tr_mon 26, NIDORINO
	tr_mon 26, NIDOQUEEN
	end_trainer

	def_trainer LIZ5, "Amos"
	...
	def_trainer GINA1, "Meadow"
	tr_mon 9, SUNKERN
	tr_mon 9, HOPPIP
	tr_mon 12, BULBASAUR
	end_trainer

	def_trainer GINA2, "Meadow"
	tr_mon 14, SUNKERN
	tr_mon 14, HOPPIP
	tr_mon 17, IVYSAUR
	end_trainer

	def_trainer GINA3, "Meadow"
	tr_mon 26, SUNFLORA
	tr_mon 27, SKIPLOOM
	tr_mon 29, IVYSAUR
	end_trainer

	def_trainer GINA4, "Meadow"
	tr_mon 30, SUNFLORA
	tr_mon 31, JUMPLUFF
	tr_mon 32, IVYSAUR
	end_trainer

	def_trainer GINA5, "Meadow"
	tr_mon 33, SUNFLORA
if DEF(FAITHFUL)
...
endc
	...
	def_trainer ERIN1, "Gina"
	tr_mon 18, PONYTA
	tr_mon 16, ODDISH
	end_trainer

	def_trainer ERIN2, "Gina"
	tr_mon 32, PONYTA
	tr_mon 32, GLOOM
	end_trainer

	def_trainer ERIN3, "Gina"
	tr_mon 36, RAPIDASH
	...
	def_trainer TIFFANY1, "Erin"
	tr_mon 31, CLEFAIRY
		tr_moves ENCORE, SING, TRI_ATTACK, MINIMIZE
	end_trainer

	def_trainer TIFFANY2, "Erin"
	tr_mon 40, CLEFAIRY
		tr_moves REFLECT, TRI_ATTACK, MINIMIZE, METRONOME
	end_trainer

	def_trainer TIFFANY3, "Erin"
	tr_mon 44, CLEFABLE
		tr_moves METRONOME, ENCORE, HEALINGLIGHT, MINIMIZE
	end_trainer

	def_trainer TIFFANY4, "Erin"
	tr_mon 49, CLEFABLE
		tr_moves HEALINGLIGHT, TRI_ATTACK, MINIMIZE, METRONOME
	end_trainer

	def_trainer KIM, "Tiffany"
	tr_mon 17, VULPIX
	end_trainer

	def_trainer CINDY, "Kim"
	tr_mon 61, NIDOQUEEN
	end_trainer

	def_trainer HOPE, "Cindy"
	tr_mon 62, FLAAFFY
	end_trainer

	def_trainer SHARON, "Hope"
	tr_mon 50, FURRET
	tr_mon 52, RAPIDASH
	end_trainer

	def_trainer DEBRA, "Sharon"
	tr_mon 50, SEAKING
	end_trainer

	def_trainer HEIDI, "Debra"
	tr_mon 53, JUMPLUFF
	tr_mon 53, JUMPLUFF
	end_trainer

	def_trainer EDNA, "Heidi"
	tr_mon 51, NIDORINA
	tr_mon 55, RAICHU
	end_trainer

	def_trainer TANYA, "Edna"
	tr_mon 61, EXEGGUTOR
	end_trainer

	def_trainer LILY, "Tanya"
	tr_mon LEVEL_FROM_BADGES + 4, NIDORINA
	tr_mon LEVEL_FROM_BADGES + 2, BELLSPROUT
	tr_mon LEVEL_FROM_BADGES + 6, WEEPINBELL
	end_trainer

	def_trainer PIPER, "Lily"
	tr_mon 55, HYPNO
	end_trainer

	def_trainer GINGER, "Piper"
	tr_mon 54, MUNCHLAX
	end_trainer

	def_trainer CHEYENNE, "Ginger"
	tr_mon 62, RAICHU
	end_trainer

	def_trainer ADRIAN, "Cheyenne"
	tr_mon 62, PARASECT
	end_trainer

	def_trainer ZANE, "Adrian"
	tr_mon 54, JOLTEON
	tr_mon 53, RAICHU
...
TwinsGroup:
	...
	def_trainer AMYANDMIMI1, "Zane"
	tr_mon 13, SPINARAK
	tr_mon 13, LEDYBA
	end_trainer

	def_trainer AMYANDMIMI2, "Zane"
	tr_mon 13, LEDYBA
	tr_mon 13, SPINARAK
	end_trainer

	def_trainer ANNANDANNE1, "Amy & Mimi"
	tr_mon 16, MARILL
	...
	def_trainer ANNANDANNE2, "Amy & Mimi"
	tr_mon 16, MAREEP
		tr_moves GROWL, THUNDER_WAVE, THUNDERSHOCK, MUD_SLAP
	tr_mon 16, MARILL
		tr_moves DEFENSE_CURL, ROLLOUT, BUBBLE_BEAM, DIZZY_PUNCH
	...
	def_trainer JOANDZOE1, "Tori & Til"
	tr_mon 59, VICTREEBEL
	tr_mon 59, VILEPLUME
	end_trainer

	def_trainer JOANDZOE2, "Tori & Til"
	tr_mon 59, VILEPLUME
	tr_mon 59, VICTREEBEL
	end_trainer

	def_trainer MEGANDPEG1, "Lo & Zoe"
	tr_mon 45, TEDDIURSA
	tr_mon 45, PHANPY
	end_trainer

	def_trainer MEGANDPEG2, "Lo & Zoe"
	tr_mon 45, PHANPY
	tr_mon 45, TEDDIURSA
	end_trainer

	def_trainer LEAANDPIA1, "Meg & Peg"
	tr_mon 38, DRATINI
	...
	def_trainer LEAANDPIA2, "Meg & Peg"
	tr_mon 38, DRATINI
		tr_moves THUNDER_WAVE, DRAGON_PULSE, ICE_BEAM, HEADBUTT
	tr_mon 38, DRATINI
		tr_moves THUNDER_WAVE, DRAGON_PULSE, FLAMETHROWER, HEADBUTT
	...
	def_trainer DAYANDDANI1, "Lea & Pia"
	tr_mon 51, PIKACHU
	tr_mon 51, PIKACHU
	end_trainer

	def_trainer DAYANDDANI2, "Lea & Pia"
	tr_mon 51, PIKACHU
	tr_mon 51, PIKACHU
	end_trainer

	def_trainer KAYANDTIA1, "Day & Dani"
	tr_mon 56, QUAGSIRE
	tr_mon 56, CLODSIRE
	end_trainer

	def_trainer KAYANDTIA2, "Day & Dani"
	tr_mon 56, CLODSIRE
	tr_mon 56, QUAGSIRE
	end_trainer
...
FisherGroup:
	...
	def_trainer RALPH1, "Kay & Tia"
	tr_mon 11, GOLDEEN
	end_trainer

	def_trainer RALPH2, "Kay & Tia"
	tr_mon 17, GOLDEEN
	end_trainer

	def_trainer RALPH3, "Kay & Tia"
	tr_mon 17, QWILFISH
	tr_mon 19, GOLDEEN
	end_trainer

	def_trainer RALPH4, "Kay & Tia"
	tr_mon 30, QWILFISH
	tr_mon 32, SEAKING
	end_trainer

	def_trainer RALPH5, "Kay & Tia"
	tr_mon 36, QWILFISH
	...
	def_trainer TULLY1, "Ralph"
	tr_mon 30, QWILFISH
	end_trainer

	def_trainer TULLY2, "Ralph"
	tr_mon 35, GOLDEEN
	tr_mon 35, QWILFISH
	end_trainer

	def_trainer TULLY3, "Ralph"
	tr_mon 40, POLIWHIRL
	tr_mon 40, SEAKING
	tr_mon 40, QWILFISH
	end_trainer

	def_trainer TULLY4, "Ralph"
	tr_mon 43, POLIWRATH
	...
	def_trainer WILTON1, "Tully"
	tr_mon 34, GOLDEEN
	tr_mon 36, REMORAID
	tr_mon 36, SEAKING
	end_trainer

	def_trainer WILTON2, "Tully"
	tr_mon 36, GOLDEEN
	tr_mon 38, REMORAID
	tr_mon 38, SEAKING
	end_trainer

	def_trainer WILTON3, "Tully"
	tr_mon 38, GOLDEEN
	...
	def_trainer ARNOLD, "Justin"
	tr_mon 62, CLOYSTER
	end_trainer

	def_trainer KYLE, "Arnold"
	tr_mon 57, SEAKING
	tr_mon 54, QWILFISH
	tr_mon 57, SEAKING
	end_trainer

	def_trainer HENRY, "Kyle"
	tr_mon 9, POLIWAG
	tr_mon 9, POLIWAG
	end_trainer


	def_trainer MARVIN, "Henry"
	tr_mon 20, MAGIKARP, MALE | MAGIKARP_CALICO1_FORM
	tr_mon 25, MAGIKARP, MALE | MAGIKARP_CALICO2_FORM
	tr_mon 30, GYARADOS, MALE
	end_trainer

	def_trainer ANDRE, "Marvin"
	tr_mon 32, GYARADOS
	end_trainer


	def_trainer RAYMOND, "Andre"
	...
	def_trainer MARTIN, "Jonah"
	tr_mon 56, REMORAID
	tr_mon 58, OCTILLERY
	end_trainer

	def_trainer STEPHEN, "Martin"
	tr_mon 60, MAGIKARP
	tr_mon 58, QUAGSIRE
	tr_mon 55, QWILFISH
	...
	def_trainer BARNEY, "Stephen"
	tr_mon 57, GYARADOS
	tr_mon 56, GYARADOS
	tr_mon 56, GYARADOS
	end_trainer

	def_trainer SCOTT, "Barney"
	tr_mon 40, QWILFISH
	tr_mon 40, QWILFISH
	tr_mon 42, SEAKING
	end_trainer

	def_trainer PATON, "Scott"
	tr_mon LEVEL_FROM_BADGES + 0, GOLDEEN
	tr_mon LEVEL_FROM_BADGES + 2, MANTINE
	end_trainer

	def_trainer KILEY, "Paton"
	...
	def_trainer LIAM, "Murphy"
	tr_mon 62, SEADRA
	end_trainer

	def_trainer GIDEON, "Liam"
	tr_mon 60, LANTURN
	tr_mon 56, MANTINE
	end_trainer

	def_trainer HALL, "Gideon"
	tr_mon 56, "Dopefish", QWILFISH
		tr_dvs 8 HP, 7 Atk, 13 Def, 8 Spe, 2 SAt, 8 SDf ; green
	end_trainer

	def_trainer DALLAS, "Hall"
	tr_mon 61, QWILFISH
	tr_mon 63, LANTURN
	tr_mon 65, GYARADOS
	end_trainer
...
BirdKeeperGroup:
	...
	def_trainer VANCE1, "Dallas"
	tr_mon 36, PIDGEOTTO
	tr_mon 36, PIDGEOTTO
	end_trainer

	def_trainer VANCE2, "Dallas"
	tr_mon 40, PIDGEOTTO
	tr_mon 40, PIDGEOTTO
	end_trainer

	def_trainer VANCE3, "Dallas"
	tr_mon 45, PIDGEOT
	...
	def_trainer TOBY, "Theo"
	tr_mon 16, DODUO
	tr_mon 17, DODUO
	tr_mon 18, DODUO
	end_trainer

	def_trainer DENIS, "Toby"
	tr_mon 18, SPEAROW
	tr_mon 20, FEAROW
	tr_mon 18, SPEAROW
	end_trainer

	def_trainer HANK, "Denis"
	tr_mon 13, PIDGEY
	tr_mon 56, PIDGEOT
	end_trainer

	def_trainer ROY, "Hank"
	tr_mon 55, FEAROW
	tr_mon 59, PIDGEOT
	end_trainer

	def_trainer BORIS, "Roy"
	tr_mon 56, DODUO
	tr_mon 55, DODUO
	tr_mon 58, DODRIO
	end_trainer

	def_trainer BOB, "Boris"
	tr_mon 59, NOCTOWL
	end_trainer

	def_trainer PETER, "Bob"
	tr_mon 7, PIDGEY
	tr_mon 8, PIDGEY
	tr_mon 10, SPEAROW
	end_trainer

	def_trainer PERRY, "Peter"
	tr_mon 59, FARFETCH_D
	end_trainer

	def_trainer BRET, "Perry"
	tr_mon 57, PIDGEOT
	tr_mon 57, FEAROW
	end_trainer

	def_trainer MICK, "Bret"
	tr_mon 62, PIDGEOT
	tr_mon 60, MURKROW
	tr_mon 60, NOCTOWL
	end_trainer

	def_trainer POWELL, "Mick"
	tr_mon LEVEL_FROM_BADGES + 8, PIDGEOT
	end_trainer

	def_trainer BIRD_KEEPER_TONY, "Devin"
	...
	def_trainer JULIAN, "Tony"
	tr_mon LEVEL_FROM_BADGES + 0, HOOTHOOT
	tr_mon LEVEL_FROM_BADGES + 4, PIDGEOTTO
	tr_mon LEVEL_FROM_BADGES + 5, MURKROW
	end_trainer

	def_trainer BIRD_KEEPER_JUSTIN, "Tony"
	tr_mon 57, XATU
	tr_mon 50, NOCTOWL
	end_trainer

	def_trainer GAIL, "Justin"
	tr_mon 56, PIDGEOT
	tr_mon 53, PIDGEOTTO
	end_trainer

	def_trainer BIRD_KEEPER_JOSH, "Justin"
	tr_mon 55, DODRIO
	end_trainer

	def_trainer BERT, "Josh"
	tr_mon 60, SKARMORY
	tr_mon 57, DODRIO
	end_trainer

	def_trainer ERNIE, "Bert"
	tr_mon 61, PIDGEOT
	end_trainer

	def_trainer KINSLEY, "Ernie" ; MISMATCH
	tr_mon 58, FARFETCH_D
	tr_mon 58, DODRIO
	tr_mon 58, PIDGEOTTO
	end_trainer

	def_trainer EASTON, "Kinsey"
	tr_mon 57, DODUO
	tr_mon 57, DODUO
	tr_mon 59, DODRIO
	tr_mon 59, DODRIO
...
HikerGroup:
	...
	def_trainer ANTHONY1, "Trent"
	tr_mon 12, GEODUDE
	tr_mon 12, MACHOP
	end_trainer

	def_trainer ANTHONY2, "Trent"
	tr_mon 16, GEODUDE
	tr_mon 18, MACHOKE
	end_trainer

	def_trainer ANTHONY3, "Trent"
	tr_mon 25, GRAVELER
	tr_mon 27, GRAVELER
	tr_mon 29, MACHOKE
	end_trainer

	def_trainer ANTHONY4, "Trent"
	tr_mon 30, GRAVELER
	tr_mon 30, GRAVELER
	tr_mon 32, MACHOKE
	end_trainer

	def_trainer ANTHONY5, "Trent"
	tr_mon 34, GRAVELER
	...
	def_trainer PARRY1, "Anthony"
	tr_mon 30, ONIX
	end_trainer

	def_trainer PARRY2, "Anthony"
	tr_mon 36, ONIX
	tr_mon 35, PILOSWINE
	end_trainer

	def_trainer PARRY3, "Anthony"
	tr_mon 36, PILOSWINE
	...
	def_trainer RUSSELL, "Parry"
	tr_mon 6, GEODUDE
	tr_mon 8, GEODUDE
	tr_mon 10, GEODUDE
	end_trainer

	def_trainer PHILLIP, "Russell"
	tr_mon 23, GEODUDE
	tr_mon 23, GEODUDE
	tr_mon 25, GRAVELER
	end_trainer

	def_trainer LEONARD, "Phillip"
	tr_mon 23, GEODUDE
	tr_mon 25, MACHOP
	end_trainer

	def_trainer BENJAMIN, "Leonard"
	tr_mon 24, DIGLETT
	tr_mon 24, DUNSPARCE
	tr_mon 28, GLIGAR
	end_trainer

	def_trainer ERIK, "Benjamin"
	tr_mon 35, GRAVELER
	tr_mon 37, DONPHAN
	tr_mon 37, GLIGAR
	end_trainer

	def_trainer MICHAEL, "Erik"
	tr_mon 35, GEODUDE
	tr_mon 35, GRAVELER
	tr_mon 35, GOLEM
	end_trainer

	def_trainer TIMOTHY, "Michael"
	tr_mon 36, SANDSLASH
	tr_mon 37, DUGTRIO
	end_trainer

	def_trainer BAILEY, "Timothy"
	tr_mon 15, GEODUDE
	tr_mon 15, GEODUDE
	tr_mon 15, GEODUDE
	tr_mon 17, LARVITAR
	...
	def_trainer TIM, "Bailey" ; MISMATCH
	tr_mon 50, DIGLETT
	tr_mon 52, GRAVELER
	tr_mon 54, DUGTRIO
	end_trainer

	def_trainer NOLAND, "Eoin"
	tr_mon 45, DUGTRIO
	tr_mon 47, GOLEM
	end_trainer

	def_trainer SIDNEY, "Noland" ; MISMATCH
	tr_mon 53, DUGTRIO
	tr_mon 55, ONIX
	end_trainer

	def_trainer KENNY, "Clarke"
	tr_mon 54, SANDSLASH
	tr_mon 56, GRAVELER
	tr_mon 58, GOLEM
	tr_mon 56, GRAVELER
	...
	def_trainer JIM, "Kenny"
	tr_mon 57, MACHAMP
	end_trainer

	def_trainer DANIEL, "Jim"
	tr_mon 12, ONIX
	end_trainer

	def_trainer EDWIN, "Daniel"
	tr_mon 62, GOLEM
	end_trainer

	def_trainer DEVIN, "Edwin"
	tr_mon LEVEL_FROM_BADGES + 1, DUNSPARCE
	tr_mon LEVEL_FROM_BADGES + 2, ONIX
	tr_mon LEVEL_FROM_BADGES + 1, LARVITAR
	end_trainer

	def_trainer SEAMUS, "Devin"
	...
	def_trainer GERARD, "Marcos"
	tr_mon 59, RHYHORN
	tr_mon 61, RHYDON
	end_trainer

	def_trainer DENT, "Gerard"
	tr_mon 58, ONIX
	tr_mon 59, STEELIX
	tr_mon 59, GOLEM
	end_trainer

	def_trainer BRUCE, "Dent"
	tr_mon 57, GRAVELER
	tr_mon 62, RHYDON
	tr_mon 63, CLEFAIRY
	end_trainer

	def_trainer DWIGHT, "Bruce"
	tr_mon 62, MAGNETON
	tr_mon 62, STEELIX
	end_trainer

	def_trainer LESTER, "Dwight"
	tr_mon 55, CLEFABLE
	tr_mon 53, SCYTHER
	tr_mon 54, MACHOKE
	end_trainer

	def_trainer GRADY, "Lester"
	tr_mon LEVEL_FROM_BADGES + 4, GRAVELER
	tr_mon LEVEL_FROM_BADGES + 4, GRAVELER
	tr_mon LEVEL_FROM_BADGES + 5, SANDSLASH
	end_trainer

	def_trainer STEVE, "Grady"
	tr_mon LEVEL_FROM_BADGES + 7, STEELIX
	end_trainer

	def_trainer DERRICK, "Steve"
	tr_mon 53, CLODSIRE
	tr_mon 53, DUGTRIO
	tr_mon 55, GOLEM
	end_trainer

	def_trainer FLOYD, "Derrick"
	tr_mon 57, STEELIX
	end_trainer
...
GruntMGroup:
	...
	def_trainer 10, "Floyd"
	tr_mon 32, ZUBAT
	tr_mon 35, GOLBAT
	tr_mon 33, MUK
	end_trainer

	def_trainer 11, "Floyd"
	tr_mon 34, MUK
	tr_mon 35, HAUNTER
	tr_mon 36, RATICATE
	end_trainer

	def_trainer 12, "Floyd"
	tr_mon 23, RATICATE, MALE
	tr_mon 24, PERSIAN, MALE | ALOLAN_FORM
	end_trainer

	def_trainer 13, "Floyd"
	tr_mon 37, RATICATE
	end_trainer

	def_trainer 14, "Floyd"
	tr_mon 35, RATICATE
	tr_mon 35, GOLBAT
	end_trainer

	def_trainer 15, "Floyd"
	tr_mon 35, MUK
	tr_mon 35, WEEZING
	end_trainer

	def_trainer 16, "Floyd"
	...
	def_trainer 17, "Floyd"
	tr_mon 32, GOLBAT
	end_trainer

	def_trainer 18, "Floyd"
	tr_mon 27, HOUNDOUR
	tr_mon 28, GOLBAT
	tr_mon 28, RATICATE
	end_trainer

	def_trainer 19, "Floyd"
	tr_mon 28, VENONAT
	tr_mon 28, VENOMOTH
	end_trainer

	def_trainer 20, "Floyd"
	tr_mon 26, ZUBAT
	tr_mon 27, GRIMER
	tr_mon 28, MEOWTH
	end_trainer

	def_trainer 21, "Floyd"
	tr_mon 26, DROWZEE
	tr_mon 27, ZUBAT
	tr_mon 28, HAUNTER
	end_trainer

	def_trainer 22, "Floyd"
	tr_mon 23, GOLBAT
	tr_mon 23, HAUNTER
	tr_mon 23, GOLBAT
	end_trainer

	def_trainer 23, "Floyd"
	tr_mon 23, KOFFING
	tr_mon 25, HOUNDOUR
	tr_mon 23, TENTACOOL
	end_trainer

	def_trainer 24, "Floyd"
	tr_mon 37, HAUNTER
	tr_mon 36, WEEZING
	end_trainer

	def_trainer 25, "Floyd"
	tr_mon 36, TENTACRUEL
	tr_mon 35, MUK
	end_trainer

	def_trainer 26, "Floyd"
	tr_mon 23, ZUBAT
	tr_mon 24, RATICATE
	tr_mon 25, MURKROW
	end_trainer
	...
	; unused
	def_trainer 27, "Floyd"
	end_trainer

	def_trainer 28, "Floyd"
	tr_mon 33, RATICATE
	end_trainer

	def_trainer 29, "Floyd"
	tr_mon 10, RATTATA
	tr_mon 10, MEOWTH
	end_trainer

	def_trainer 30, "Floyd"
	tr_mon 25, GOLBAT
	tr_mon 25, GOLBAT
	tr_mon 30, ARBOK
	end_trainer

	def_trainer 31, "Floyd"
	tr_mon 51, GOLBAT
	tr_mon 52, WEEZING
	tr_mon 51, MUK
	end_trainer
...
PokefanMGroup:
	...
	def_trainer DEREK1, "Grunt"
	tr_mon 18, PIKACHU @ ORAN_BERRY
	end_trainer

	def_trainer DEREK2, "Grunt"
	tr_mon 19, PIKACHU @ ORAN_BERRY
	end_trainer

	def_trainer DEREK3, "Grunt"
	tr_mon 36, PIKACHU @ SITRUS_BERRY
	end_trainer

	def_trainer WILLIAM, "Derek"
	tr_mon 16, RAICHU @ ORAN_BERRY
	end_trainer

	def_trainer ROBERT, "William"
	tr_mon 56, QUAGSIRE @ SITRUS_BERRY
	end_trainer

	def_trainer JOSHUA, "Robert"
...
PokefanFGroup:
	...
	def_trainer BEVERLY1, "Allan"
	tr_mon 16, SNUBBULL @ ORAN_BERRY
	end_trainer

	def_trainer BEVERLY2, "Allan"
	tr_mon 18, SNUBBULL @ ORAN_BERRY
	end_trainer

	def_trainer BEVERLY3, "Allan"
	tr_mon 30, GRANBULL @ SITRUS_BERRY
	end_trainer

	def_trainer RUTH, "Beverly"
	tr_mon 20, PIKACHU @ ORAN_BERRY
	end_trainer

	def_trainer GEORGIA, "Ruth"
...
OfficerMGroup:
	...
	def_trainer KEITH, "Eleanor"
	tr_mon 15, GROWLITHE
	tr_mon 15, GROWLITHE
	end_trainer

	def_trainer DIRK, "Keith"
	tr_mon 15, GROWLITHE
	tr_mon 15, MACHOP
	end_trainer
...
OfficerFGroup:
	...
	def_trainer JAMIE, "Dirk"
	tr_mon 54, GROWLITHE
	tr_mon 58, ARCANINE
	tr_mon 57, BLASTOISE
	end_trainer

	def_trainer MARA, "Jamie"
	tr_mon 17, GROWLITHE
	end_trainer

	def_trainer JENNY, "Mara"
	tr_mon 53, SQUIRTLE
	tr_mon 53, SQUIRTLE
	tr_mon 53, SQUIRTLE
	tr_mon 53, SQUIRTLE
...
PokemaniacGroup:
	...
	def_trainer BRENT1, "Winifred"
	tr_mon 32, LICKITUNG
	end_trainer

	def_trainer BRENT2, "Winifred"
	tr_mon 37, KANGASKHAN
	end_trainer

	def_trainer BRENT3, "Winifred"
	tr_mon 42, PORYGON
		tr_moves RECOVER, PSYCHIC_M, CONVERSION, TRI_ATTACK
	end_trainer

	def_trainer BRENT4, "Winifred"
	tr_mon 47, CHANSEY
		tr_moves ROLLOUT, ATTRACT, RETURN, FRESH_SNACK
	end_trainer

	def_trainer LARRY, "Brent"
	tr_mon 12, SLOWPOKE
	end_trainer

	def_trainer ANDREW, "Larry"
	tr_mon 24, MAROWAK
	tr_mon 24, MAROWAK
	end_trainer

	def_trainer CALVIN, "Andrew"
	tr_mon 26, KANGASKHAN
	end_trainer

	def_trainer SHANE, "Calvin"
	tr_mon 20, NIDORINA
	tr_mon 20, NIDORINO
	end_trainer

	def_trainer BEN, "Shane" ; MISMATCH
	tr_mon 30, SLOWBRO
	end_trainer

	def_trainer RON, "Beckett"
	tr_mon 30, NIDOKING
	end_trainer

	def_trainer ETHAN, "Ron"
	tr_mon 45, RHYHORN
	tr_mon 46, RHYDON
	end_trainer

	def_trainer ISSAC, "Ethan"
	tr_mon 15, LICKITUNG
		tr_moves LICK, SUPERSONIC, CUT
	end_trainer

	def_trainer DONALD, "Issac"
	tr_mon 13, SLOWPOKE
	tr_mon 13, NIDORAN_M
	end_trainer

	def_trainer ZACH, "Donald"
	tr_mon 37, RHYHORN
	end_trainer

	def_trainer ENZO, "Zach"
	tr_mon LEVEL_FROM_BADGES + 8, SHUCKLE
	end_trainer

	def_trainer MILLER, "Enzo"
	tr_mon LEVEL_FROM_BADGES + 7, NIDOKING
	tr_mon LEVEL_FROM_BADGES + 7, NIDOQUEEN
	end_trainer

	def_trainer AIDAN, "Miller"
	tr_mon 36, SNORLAX
...
SuperNerdGroup:
	...
	def_trainer STAN, "Lyric"
	tr_mon 20, GRIMER
	end_trainer

	def_trainer ERIC, "Stan"
	tr_mon 13, GRIMER
	tr_mon 14, PORYGON
	end_trainer

	def_trainer SAM, "Eric"
	tr_mon 55, GRIMER
	tr_mon 56, MUK
	end_trainer

	def_trainer TOM, "Jacob" ; MISMATCH
	tr_mon 55, MAGNEMITE
	tr_mon 56, MAGNETON
	tr_mon 55, MAGNEMITE
	end_trainer

	def_trainer PAT, "Tyrone"
	tr_mon 56, PORYGON2
	end_trainer

	def_trainer SHAWN, "Pat"
	tr_mon 44, MAGNEMITE
	tr_mon 46, MUK
	tr_mon 45, MAGNETON
	end_trainer

	def_trainer TERU, "Shawn"
	tr_mon 9, MAGNEMITE
	tr_mon 13, VOLTORB
	tr_mon 9, MAGNEMITE
	tr_mon 11, MAGNEMITE
	...
	def_trainer HUGH, "Teru"
	tr_mon LEVEL_FROM_BADGES + 9, SEADRA
		tr_moves SMOKESCREEN, OUTRAGE, SURF, WATERFALL
	end_trainer

	def_trainer MARKUS, "Hugh"
	tr_mon LEVEL_FROM_BADGES + 9, SLOWBRO
		tr_moves CONFUSION, HEADBUTT, WATER_PULSE, STRENGTH
	end_trainer

	def_trainer CARY, "Markus"
	tr_mon 63, FLAREON
	end_trainer

	def_trainer WALDO, "Cary"
	tr_mon 65, CHARIZARD
	end_trainer

	def_trainer MERLE, "Waldo"
	tr_mon 63, MAGCARGO
	end_trainer

	def_trainer LUIS, "Romeo"
	tr_mon 62, MAGMAR
	tr_mon 63, WEEZING
	tr_mon 59, MAGMAR
	end_trainer

	def_trainer JOVAN, "Luis"
	tr_mon 62, MAGNETON
	tr_mon 60, VOLTORB
	tr_mon 61, ELECTRODE
	end_trainer

	def_trainer MIGUEL, "Jovan"
	...
	def_trainer RORY, "Miguel"
	tr_mon 26, PORYGON
	end_trainer

	def_trainer GREGG, "Rory"
	tr_mon 53, PORYGON
	tr_mon 55, PORYGON2
	end_trainer

	def_trainer FOOTE, "Gregg"
	tr_mon 54, SNORLAX
	end_trainer

	def_trainer DAVE, "Foote"
	tr_mon 52, LARVITAR
	tr_mon 53, PUPITAR
	tr_mon 56, PORYGON_Z
	end_trainer

	def_trainer KOUTA, "Dave"
	tr_mon 54, CROBAT
	tr_mon 53, POLITOED
	tr_mon 56, CHARIZARD
	end_trainer
...
endc
	...
	def_trainer CATHY, "Dana"
	tr_mon 18, SNUBBULL
		tr_moves SCARY_FACE, CHARM, BITE, LICK
	end_trainer

	def_trainer AMANDA, "Cathy"
	tr_mon 57, GLOOM
	tr_mon 60, ARBOK
	tr_mon 57, GLOOM
	end_trainer

	def_trainer KRISE, "Amanda"
	tr_mon 14, ODDISH
	tr_mon 17, CUBONE
	end_trainer

	def_trainer CONNIE, "Krise"
	tr_mon 20, AZUMARILL
	tr_mon 21, MAGNETON
	end_trainer

	def_trainer LINDA, "Connie"
	tr_mon 57, BULBASAUR
	tr_mon 59, IVYSAUR
	tr_mon 61, VENUSAUR
	end_trainer

	def_trainer LAURA, "Linda"
	tr_mon 52, GLOOM @ SITRUS_BERRY
	tr_mon 54, PIDGEOTTO
	tr_mon 54, BELLOSSOM
	end_trainer

	def_trainer SHANNON, "Laura"
	tr_mon 53, PARAS
	tr_mon 53, PARAS
	tr_mon 55, PARASECT
	end_trainer

	def_trainer MICHELLE, "Shannon"
	tr_mon 56, LEAFEON
	tr_mon 57, TANGELA
	tr_mon 58, JUMPLUFF
	end_trainer

	def_trainer ELLEN, "Michelle"
	tr_mon 52, WIGGLYTUFF
	tr_mon 54, GRANBULL
	end_trainer

	def_trainer IRIS, "Ellen"
...
BeautyGroup:
	...
	def_trainer VICTORIA, "Mavis"
	tr_mon 9, SENTRET
	tr_mon 13, SENTRET
	tr_mon 17, SENTRET
	end_trainer

	def_trainer SAMANTHA, "Victoria"
	tr_mon 16, MEOWTH
	...
	def_trainer CASSIE, "Samantha"
	tr_mon 47, VILEPLUME
	tr_mon 49, BUTTERFREE
	end_trainer

	def_trainer JULIA, "Cassie"
	tr_mon 56, PARAS
	tr_mon 56, EXEGGCUTE
	tr_mon 59, PARASECT
	end_trainer

	def_trainer VALENCIA, "Julia"
	tr_mon 18, SUNKERN
	tr_mon 18, SKIPLOOM
	tr_mon 18, SUNFLORA
	end_trainer

	def_trainer OLIVIA, "Valencia"
	tr_mon 19, CORSOLA
	end_trainer

	def_trainer CALLIE, "Olivia"
	tr_mon 16, CLEFABLE
	tr_mon 16, WIGGLYTUFF
	end_trainer

	def_trainer CASSANDRA, "Callie"
	tr_mon 16, CLEFABLE
	tr_mon 16, WIGGLYTUFF
	end_trainer

	def_trainer CHARLOTTE, "Cassandra"
	tr_mon 20, "Blossom", BELLOSSOM, FEMALE
		tr_extra SHINY
	end_trainer

	def_trainer BRIDGET, "Charlotte"
	tr_mon 55, CORSOLA
	tr_mon 55, SUNFLORA
	end_trainer

	def_trainer VERONICA, "Bridget"
	tr_mon 54, WIGGLYTUFF
	tr_mon 54, MILTANK
	tr_mon 56, CLEFABLE
	end_trainer

	def_trainer BEAUTY_NICOLE, "Rosa"
...
BugManiacGroup:
	...
	def_trainer DANE, "Doug"
	tr_mon 59, BEEDRILL
	tr_mon 61, BUTTERFREE
	end_trainer

	def_trainer DION, "Dane"
	tr_mon 63, ARIADOS
	end_trainer

	def_trainer STACEY, "Dion"
	tr_mon 60, METAPOD
	tr_mon 62, METAPOD
	tr_mon 64, METAPOD
	end_trainer

	def_trainer ELLIS, "Stacey"
	tr_mon 58, WEEDLE
	tr_mon 60, KAKUNA
	tr_mon 62, BEEDRILL
	end_trainer

	def_trainer ABNER, "Ellis"
	tr_mon 59, BUTTERFREE
	tr_mon 59, BEEDRILL
	tr_mon 59, PIKACHU
	end_trainer

	def_trainer KENTA, "Abner"
	tr_mon 60, BEEDRILL
	tr_mon 60, BEEDRILL
	tr_mon 60, PARASECT
	end_trainer

	def_trainer ROBBY, "Kenta"
	tr_mon 60, BUTTERFREE
	tr_mon 60, BUTTERFREE
	tr_mon 60, PARASECT
	end_trainer

	def_trainer PIERRE, "Robby"
	tr_mon 54, YANMA
	tr_mon 54, YANMA
	tr_mon 56, YANMEGA
	end_trainer

	def_trainer DYLAN, "Pierre"
	tr_mon 55, LEDIAN
	tr_mon 55, BUTTERFREE
	end_trainer

	def_trainer KAI, "Dylan"
...
RuinManiacGroup:
	...
	def_trainer JONES, "Kai"
	tr_mon 8, OMANYTE
	tr_mon 8, KABUTO
	end_trainer

	def_trainer LELAND, "Jones"
	tr_mon 23, DUNSPARCE
	tr_mon 25, AERODACTYL
	end_trainer

	def_trainer PETRY, "Leland"
	tr_mon 23, OMANYTE
	tr_mon 23, KABUTO
	tr_mon 25, AERODACTYL
	end_trainer

	def_trainer GLYN, "Petry"
	tr_mon 25, OMASTAR
	tr_mon 25, KABUTOPS
	end_trainer

	def_trainer SMILTE, "Glyn"
	tr_mon 54, SANDSLASH
	tr_mon 54, DUGTRIO
...
FirebreatherGroup:
	...
	def_trainer OTIS, "Smilte"
	tr_mon 59, MAGMAR
	tr_mon 58, WEEZING
	tr_mon 61, MAGMAR
	end_trainer

	def_trainer DICK, "Otis"
	tr_mon 53, CHARMANDER
	tr_mon 55, CHARMELEON
	tr_mon 57, CHARIZARD
	end_trainer

	def_trainer NED, "Dick"
	tr_mon 16, KOFFING
	tr_mon 17, GROWLITHE
	tr_mon 16, KOFFING
	end_trainer

	def_trainer BURT, "Ned"
	tr_mon 59, WEEZING
	tr_mon 61, MAGCARGO
	end_trainer

	def_trainer BILL, "Larry"
	tr_mon 8, KOFFING
	tr_mon 8, KOFFING
	end_trainer

	def_trainer WALT, "Bill"
	tr_mon 11, MAGMAR
	tr_mon 16, MAGMAR
	end_trainer

	def_trainer RAY, "Kieran"
	tr_mon 11, VULPIX
	end_trainer

	def_trainer LYLE, "Ray"
	tr_mon 44, KOFFING
	tr_mon 46, FLAREON
	tr_mon 45, WEEZING
	end_trainer

	def_trainer JAY, "Lyle"
	tr_mon 26, MAGMAR
	end_trainer

	def_trainer OLEG, "Jay"
	tr_mon LEVEL_FROM_BADGES + 6, WEEZING
	end_trainer

	def_trainer TALA, "Oleg"
	tr_mon 61, WEEZING
	tr_mon 62, MAGMORTAR
	end_trainer
...
;	end_trainer
	...
	def_trainer FRITZ, "Irwin"
	tr_mon 45, MR__MIME
	tr_mon 45, MAGMAR
	tr_mon 45, MACHOKE
	end_trainer

	def_trainer HORTON, "Irwin"
	tr_mon 53, ELECTRODE
	tr_mon 53, ELECTRODE
	tr_mon 53, ELECTRODE
	end_trainer
...
SchoolboyGroup:
	...
	def_trainer JACK1, "Horton"
	tr_mon 12, ODDISH
	tr_mon 15, VOLTORB
	end_trainer

	def_trainer JACK2, "Horton"
	tr_mon 14, ODDISH
	tr_mon 17, VOLTORB
	end_trainer

	def_trainer JACK3, "Horton"
	tr_mon 28, GLOOM
	tr_mon 31, ELECTRODE
	end_trainer

	def_trainer JACK4, "Horton"
	tr_mon 30, GLOOM
	tr_mon 33, GROWLITHE
	tr_mon 33, ELECTRODE
	end_trainer

	def_trainer JACK5, "Horton"
	tr_mon 35, ELECTRODE
	...
	def_trainer ALAN1, "Jack"
	tr_mon 17, TANGELA
	end_trainer

	def_trainer ALAN2, "Jack"
	tr_mon 17, TANGELA
	tr_mon 17, YANMA
	end_trainer

	def_trainer ALAN3, "Jack"
	tr_mon 20, NATU
	tr_mon 22, TANGELA
	tr_mon 20, QUAGSIRE
	tr_mon 25, YANMA
	...
	def_trainer CHAD1, "Alan"
	tr_mon 20, MR__MIME
	end_trainer

	def_trainer CHAD2, "Alan"
	tr_mon 20, MR__MIME
	tr_mon 20, MAGNEMITE
	end_trainer

	def_trainer CHAD3, "Alan"
	tr_mon 27, MR__MIME
	tr_mon 31, MAGNETON
	end_trainer

	def_trainer CHAD4, "Alan"
	tr_mon 30, MR__MIME
	tr_mon 34, MAGNETON
	end_trainer

	def_trainer CHAD5, "Alan"
	tr_mon 34, MR__MIME
	...
	def_trainer NATE, "Joe"
	tr_mon 46, LEDIAN
	tr_mon 48, EXEGGUTOR
	end_trainer

	def_trainer RICKY, "Billy"
	tr_mon 44, AIPOM
	tr_mon 46, DITTO
	end_trainer

	def_trainer SHERMAN, "Nate"
	tr_mon 59, FURRET
	tr_mon 61, PIDGEOT
	end_trainer

	def_trainer SCHOOLBOY_CONNOR, "Kevin"
	tr_mon 59, SENTRET
	end_trainer

	def_trainer TORIN, "Sherman"
	tr_mon 58, SANDSLASH
	tr_mon 55, GOLBAT
	end_trainer

	def_trainer TRAVIS, "Connor"
	tr_mon 59, ODDISH
	end_trainer
...
PsychicGroup:
	...
	def_trainer NATHAN, "Isabel"
	tr_mon 26, GIRAFARIG
	end_trainer

	def_trainer FRANKLIN, "Imogen"
	tr_mon 53, KADABRA
	tr_mon 56, GIRAFARIG
	end_trainer

	def_trainer HERMAN, "Nathan"
	tr_mon 53, EXEGGCUTE
	tr_mon 53, EXEGGCUTE
	tr_mon 55, EXEGGUTOR
	end_trainer

	def_trainer FIDEL, "Franklin"
	tr_mon 57, XATU
	end_trainer

	def_trainer GREG, "Herman"
	tr_mon 17, DROWZEE
		tr_moves HYPNOSIS, DISABLE, DREAM_EATER
	end_trainer

	def_trainer NORMAN, "Fidel"
	tr_mon 17, SLOWPOKE
	...
	def_trainer PHIL, "Norman"
	tr_mon 36, KADABRA
	tr_mon 35, XATU
	end_trainer

	def_trainer RICHARD, "Mark" ; MISMATCH
	tr_mon 44, ESPEON
	end_trainer

	def_trainer GILBERT, "Phil"
	tr_mon 38, STARMIE
	tr_mon 36, EXEGGCUTE
	tr_mon 40, GIRAFARIG
	end_trainer

	def_trainer JARED, "Vernon"
	tr_mon 53, MR__MIME
	tr_mon 55, EXEGGCUTE
	tr_mon 55, EXEGGCUTE
	end_trainer

	def_trainer RODNEY, "Gilbert"
	tr_mon 45, DROWZEE
	tr_mon 47, HYPNO
	end_trainer

	def_trainer LEON, "Jared"
	tr_mon 54, NOCTOWL
	tr_mon 55, HYPNO
	tr_mon 53, GIRAFARIG
	end_trainer

	def_trainer URI, "Rodney"
	tr_mon 57, "Hocus", KADABRA
	tr_mon 57, "Pocus", KADABRA
	end_trainer

	def_trainer VIRGIL, "Jared"
...
HexManiacGroup:
	...
	def_trainer NATALIE, "Amy"
	tr_mon 54, DROWZEE
	tr_mon 54, DROWZEE
	tr_mon 56, HYPNO
	end_trainer

	def_trainer VIVIAN, "Luna"
	tr_mon 54, HAUNTER
	tr_mon 52, HAUNTER
	tr_mon 54, HAUNTER
	tr_mon 56, ALAKAZAM
...
SageGroup:
	...
	def_trainer CHOW, "Bethany"
	tr_mon 3, BELLSPROUT
	tr_mon 3, BELLSPROUT
	tr_mon 3, BELLSPROUT
	end_trainer

	def_trainer NICO, "Coryn"
	tr_mon 3, BELLSPROUT
	tr_mon 3, BELLSPROUT
	tr_mon 3, HOOTHOOT
	end_trainer

	def_trainer JIN, "Chow"
	tr_mon 7, BELLSPROUT
	end_trainer

	def_trainer TROY, "Nico"
	tr_mon 7, BELLSPROUT
	tr_mon 7, GASTLY
	end_trainer

	def_trainer JEFFREY, "Jin"
	tr_mon 22, HAUNTER
	tr_mon 21, VULPIX
	end_trainer

	def_trainer PING, "Troy"
	tr_mon 17, GASTLY
	tr_mon 17, HOOTHOOT
	tr_mon 18, GASTLY
	tr_mon 18, NOCTOWL
	...
	def_trainer EDMOND, "Jeffrey"
	tr_mon 3, BELLSPROUT
	tr_mon 3, HOOTHOOT
	tr_mon 3, BELLSPROUT
	end_trainer

	def_trainer NEAL, "Ping"
	tr_mon 6, BELLSPROUT
	tr_mon 6, HOOTHOOT
	end_trainer
...
MediumGroup:
	...
	def_trainer MARTHA, "Edmond"
	tr_mon 18, GASTLY
	tr_mon 20, HAUNTER
	tr_mon 20, MISDREAVUS
	end_trainer

	def_trainer GRACE, "Neal"
	tr_mon 20, HAUNTER
	tr_mon 20, MISDREAVUS
	end_trainer

	def_trainer REBECCA, "Martha"
	tr_mon 54, DROWZEE
	tr_mon 54, HYPNO
	end_trainer

	def_trainer DORIS, "Grace"
	tr_mon 53, SLOWPOKE
	tr_mon 55, SLOWBRO
	end_trainer
...
SrAndJrGroup:
	...
	def_trainer JOANDCATH1, "Koji"
	tr_mon 18, TEDDIURSA
	tr_mon 16, JIGGLYPUFF
	end_trainer

	def_trainer JOANDCATH2, "Koji"
	tr_mon 16, JIGGLYPUFF
	tr_mon 18, TEDDIURSA
	end_trainer

	def_trainer IVYANDAMY1, "Jo & Cath"
	tr_mon 30, FLAAFFY
	tr_mon 28, GLOOM
	end_trainer

	def_trainer IVYANDAMY2, "Jo & Cath"
	tr_mon 28, GLOOM
	tr_mon 30, FLAAFFY
	end_trainer

	def_trainer BEAANDMAY1, "Ivy & Amy"
	tr_mon LEVEL_FROM_BADGES + 4, IVYSAUR
	tr_mon LEVEL_FROM_BADGES + 0, BULBASAUR
	end_trainer

	def_trainer BEAANDMAY2, "Ivy & Amy"
	tr_mon LEVEL_FROM_BADGES + 0, BULBASAUR
	tr_mon LEVEL_FROM_BADGES + 4, IVYSAUR
	end_trainer
...
CoupleGroup:
	...
	def_trainer GAILANDELI1, "Bea & May"
	...
	def_trainer GAILANDELI2, "Bea & May"
	tr_mon 15, PIKACHU, FEMALE
	tr_mon 13, POLIWAG, FEMALE
	tr_mon 13, SANDSHREW, MALE
	tr_mon 15, MARILL, MALE
	...
	def_trainer DUFFANDEDA1, "Gail & Eli"
	tr_mon LEVEL_FROM_BADGES + 2, CLOYSTER, FEMALE
	tr_mon LEVEL_FROM_BADGES + 2, ONIX, MALE
	end_trainer

	def_trainer DUFFANDEDA2, "Gail & Eli"
	tr_mon LEVEL_FROM_BADGES + 2, ONIX, MALE
	tr_mon LEVEL_FROM_BADGES + 2, CLOYSTER, FEMALE
	end_trainer

	def_trainer FOXANDRAE1, "Duff & Eda"
	tr_mon LEVEL_FROM_BADGES + 6, FLAREON, MALE
	tr_mon LEVEL_FROM_BADGES + 6, GLACEON, FEMALE
	end_trainer

	def_trainer FOXANDRAE2, "Duff & Eda"
	tr_mon LEVEL_FROM_BADGES + 6, GLACEON, FEMALE
	tr_mon LEVEL_FROM_BADGES + 6, FLAREON, MALE
	end_trainer

	def_trainer MOEANDLULU1, "Fox & Rae"
	tr_mon 53, GLOOM, MALE
	tr_mon 53, WEEPINBELL, FEMALE
	end_trainer

	def_trainer MOEANDLULU2, "Fox & Rae"
	tr_mon 53, WEEPINBELL, FEMALE
	tr_mon 53, GLOOM, MALE
	end_trainer

	def_trainer VICANDTARA1, "Moe & Lulu"
	tr_mon 54, MAGMAR, MALE
	tr_mon 53, SUNKERN, FEMALE
	end_trainer

	def_trainer VICANDTARA2, "Moe & Lulu"
	tr_mon 53, SUNKERN, FEMALE
	tr_mon 54, MAGMAR, MALE
	end_trainer

	def_trainer TIMANDSUE1, "Vic & Tara"
	tr_mon 53, KADABRA, MALE
	tr_mon 57, GOLDUCK, FEMALE
	end_trainer

	def_trainer TIMANDSUE2, "Vic & Tara"
	tr_mon 57, GOLDUCK, FEMALE
	tr_mon 53, KADABRA, MALE
	end_trainer

	def_trainer JOEANDJO1, "Tim & Sue"
	tr_mon 56, ALAKAZAM, MALE
	tr_mon 52, BUTTERFREE, FEMALE
	end_trainer

	def_trainer JOEANDJO2, "Tim & Sue"
	tr_mon 52, BUTTERFREE, FEMALE
	tr_mon 56, ALAKAZAM, MALE
	end_trainer
...
GentlemanGroup:
	...
	def_trainer PRESTON, "Joe & Jo"
	tr_mon 18, GROWLITHE
	tr_mon 18, SKARMORY
	end_trainer

	def_trainer EDWARD, "Joe & Jo"
	tr_mon 49, PERSIAN
	end_trainer

	def_trainer GREGORY, "Preston"
	tr_mon 56, PIKACHU
	tr_mon 53, FLAAFFY
	tr_mon 53, CHINCHOU
	end_trainer

	def_trainer ALFRED, "Edward"
	tr_mon 22, NOCTOWL
	end_trainer

	def_trainer MILTON, "Gregory"
	tr_mon 53, GROWLITHE
	tr_mon 56, ARCANINE
	end_trainer

	def_trainer CAMUS, "Alfred"
	tr_mon 55, SKARMORY
	tr_mon 56, ARCANINE
	tr_mon 54, PERSIAN
	end_trainer

	def_trainer GEOFFREY, "Milton"
	tr_mon 50, MEOWTH
	end_trainer
...
RichBoyGroup:
	...
	def_trainer WINSTON, "Camus"
	tr_mon 46, PIDGEOT
	tr_mon 44, FURRET
	tr_mon 45, AMPHAROS
	end_trainer

	def_trainer GERALD, "Geoffrey"
	tr_mon 42, AZUMARILL @ NUGGET
	tr_mon 40, BLISSEY @ NUGGET
	end_trainer

	def_trainer IRVING, "Winston"
...
endc
	...
	def_trainer SHARYN, "Brenda"
	tr_mon 46, MILTANK
	tr_mon 46, TAUROS
	end_trainer

	def_trainer MARGARET, "Chelsie"
	tr_mon 55, CHANSEY
	tr_mon 55, MILTANK
	end_trainer

	def_trainer OLGA, "Sharyn"
	tr_mon 50, TEDDIURSA
	tr_mon 55, URSARING
	tr_mon 53, CHANSEY
	end_trainer
...
SailorGroup:
	...
	def_trainer HUEY1, "Daniela"
	tr_mon 18, POLIWAG
	tr_mon 20, POLIWHIRL
	end_trainer

	def_trainer HUEY2, "Daniela"
	tr_mon 28, POLIWHIRL
	tr_mon 28, POLIWHIRL
	end_trainer

	def_trainer HUEY3, "Daniela"
	tr_mon 34, POLIWHIRL
	tr_mon 34, POLIWRATH
	end_trainer

	def_trainer HUEY4, "Daniela"
	tr_mon 38, POLITOED
	...
	def_trainer EUGENE, "Huey"
	tr_mon 17, POLIWHIRL
	tr_mon 17, RATICATE
	tr_mon 19, KRABBY
	end_trainer

	def_trainer TERRELL, "Huey"
	tr_mon 20, POLIWHIRL
	end_trainer

	def_trainer KENT, "Eugene"
	tr_mon 18, KRABBY
	...
	def_trainer ERNEST, "Terrell" ; MISMATCH
	tr_mon 18, MACHOP
	tr_mon 18, MACHOP
	tr_mon 18, POLIWHIRL
	end_trainer

	def_trainer JEFF, "Kent"
	tr_mon 46, RATICATE
	tr_mon 46, RATICATE
	end_trainer

	def_trainer GARRETT, "Sanders"
	tr_mon 48, KINGLER
	end_trainer

	def_trainer KENNETH, "Jeff"
	tr_mon 44, MACHOP
	tr_mon 45, MACHOKE
	tr_mon 46, POLIWRATH
	tr_mon 45, MACHOKE
	...
	def_trainer STANLY, "Garrett" ; MISMATCH
	tr_mon 45, MACHOP
	tr_mon 48, MACHOKE
	tr_mon 44, PSYDUCK
	end_trainer

	def_trainer HARRY, "Kenneth"
	tr_mon 20, WOOPER
	end_trainer

	def_trainer PARKER, "Stanley"
	tr_mon 56, HORSEA
	tr_mon 57, SEADRA
	end_trainer

	def_trainer EDDIE, "Harry"
	tr_mon 59, AZUMARILL
	end_trainer

	def_trainer HARVEY, "Parker"
...
SwimmerMGroup:
	...
	def_trainer HAROLD, "Eddie"
	tr_mon 60, REMORAID
	tr_mon 58, SEADRA
	end_trainer

	def_trainer SIMON, "Harvey"
	tr_mon 20, TENTACOOL
	tr_mon 20, TENTACOOL
	end_trainer

	def_trainer RANDALL, "Harold"
	tr_mon 18, SHELLDER
	tr_mon 20, WARTORTLE
	tr_mon 18, SHELLDER
	end_trainer

	def_trainer CHARLIE, "Simon"
	tr_mon 21, SHELLDER
	tr_mon 19, TENTACOOL
	tr_mon 19, TENTACRUEL
	end_trainer

	def_trainer GEORGE, "Randall"
	tr_mon 16, TENTACOOL
	tr_mon 17, TENTACOOL
	tr_mon 16, TENTACOOL
	tr_mon 19, STARYU
	...
	def_trainer BERKE, "Charlie"
	tr_mon 23, QWILFISH
	end_trainer

	def_trainer KIRK, "George"
	tr_mon 20, GYARADOS
	tr_mon 20, GYARADOS
	end_trainer

	def_trainer MATHEW, "Berke"
	tr_mon 23, KRABBY
	end_trainer

	def_trainer HAL, "Kirk"
	tr_mon 24, SEEL
	tr_mon 25, DEWGONG
	tr_mon 24, SEEL
	end_trainer

	def_trainer JEROME, "Mathew"
	tr_mon 57, SEADRA
	tr_mon 58, TENTACOOL
...
SwimmerFGroup:
	...
	def_trainer ELAINE, "Ezra"
	tr_mon 21, STARYU
	end_trainer

	def_trainer PAULA, "Ashe"
	tr_mon 19, STARYU
	tr_mon 19, SHELLDER
	end_trainer

	def_trainer KAYLEE, "Elaine"
	tr_mon 18, GOLDEEN
	tr_mon 20, GOLDEEN
	tr_mon 20, SEAKING
	end_trainer

	def_trainer SUSIE, "Paula"
	tr_mon 20, PSYDUCK
	tr_mon 22, GOLDEEN
	end_trainer

	def_trainer DENISE, "Kaylee"
	tr_mon 22, SEEL
	end_trainer

	def_trainer KARA, "Susie"
	tr_mon 20, STARYU
	tr_mon 20, STARMIE
	end_trainer

	def_trainer WENDY, "Denise"
	tr_mon 21, HORSEA
	...
	def_trainer MARY, "Kara"
	tr_mon 20, GYARADOS
	end_trainer

	def_trainer DAWN, "Wendy" ; MISMATCH
	tr_mon 61, AZUMARILL
	end_trainer

	def_trainer NICOLE, "Rosa"
	tr_mon 59, MARILL
	tr_mon 59, MARILL
	tr_mon 62, LAPRAS
	end_trainer

	def_trainer LORI, "Debbie"
	tr_mon 62, STARMIE
	tr_mon 62, STARMIE
	tr_mon 62, STARMIE
	end_trainer

	def_trainer NIKKI, "Nicole"
	tr_mon 58, SEEL
	tr_mon 58, SEEL
	tr_mon 58, SEEL
	tr_mon 62, DEWGONG
	...
	def_trainer DIANA, "Lori"
	tr_mon 58, GOLDUCK
	end_trainer

	def_trainer BRIANA, "Nikki"
	tr_mon 56, SEAKING
	tr_mon 56, LAPRAS
	end_trainer

	def_trainer VIOLA, "Diana"
	tr_mon 58, CLOYSTER
	end_trainer

	def_trainer KATIE, "Briana" ; MISMATCH
	tr_mon LEVEL_FROM_BADGES + 3, LANTURN
	end_trainer

	def_trainer JILL, "Viola"
	tr_mon LEVEL_FROM_BADGES + 3, DEWGONG
	end_trainer

	def_trainer LISA, "Lisa" ; MISMATCH
	tr_mon LEVEL_FROM_BADGES + 0, SEEL
	tr_mon LEVEL_FROM_BADGES + 2, DEWGONG
	end_trainer

	def_trainer ALISON, "Jill"
	tr_mon LEVEL_FROM_BADGES + 4, CORSOLA
	tr_mon LEVEL_FROM_BADGES + 4, SEEL
	end_trainer

	def_trainer STEPHANIE, "Katie"
	tr_mon LEVEL_FROM_BADGES + 3, STARYU
	tr_mon LEVEL_FROM_BADGES + 5, SEADRA
	end_trainer

	def_trainer CAROLINE, "Alison"
	tr_mon LEVEL_FROM_BADGES + 3, REMORAID
	tr_mon LEVEL_FROM_BADGES + 3, REMORAID
	tr_mon LEVEL_FROM_BADGES + 3, REMORAID
	end_trainer

	def_trainer NATALIA, "Stephanie"
	tr_mon LEVEL_FROM_BADGES + 4, STARYU
	tr_mon LEVEL_FROM_BADGES + 4, STARYU
	end_trainer

	def_trainer BARBARA, "Caroline"
	tr_mon LEVEL_FROM_BADGES + 5, STARMIE
	end_trainer

	def_trainer SALLY, "Natalia"
	tr_mon LEVEL_FROM_BADGES + 1, REMORAID
	tr_mon LEVEL_FROM_BADGES + 3, MANTINE
	end_trainer

	def_trainer TARA, "Barbara"
	tr_mon LEVEL_FROM_BADGES + 2, CORSOLA
	tr_mon LEVEL_FROM_BADGES + 2, CORSOLA
	end_trainer

	def_trainer MAYU, "Sally"
	tr_mon 58, CORSOLA
	tr_mon 59, CORSOLA
	tr_mon 60, CORSOLA
	end_trainer

	def_trainer LEONA, "Tara"
	tr_mon 62, POLITOED
	end_trainer

	def_trainer CHELAN, "Mayu"
	tr_mon 61, AZUMARILL
	end_trainer

	def_trainer KENDRA, "Leona"
	tr_mon 62, SLOWKING
	end_trainer

	def_trainer WODA, "Chelan"
	tr_mon 57, MANTINE
	tr_mon 57, OCTILLERY
	end_trainer

	def_trainer RACHEL, "Kendra"
	tr_mon 53, REMORAID
	tr_mon 53, REMORAID
	tr_mon 53, REMORAID
	tr_mon 55, MANTINE
...
BurglarGroup:
	...
	def_trainer DUNCAN, "Serra"
	tr_mon 34, KOFFING
	tr_mon 35, MAGMAR
	tr_mon 34, WEEZING
	end_trainer

	def_trainer ORSON, "Marina"
	tr_mon 36, GROWLITHE
	tr_mon 34, WEEZING
	end_trainer

	def_trainer COREY, "Connor"
	...
	def_trainer PETE, "Orson"
	tr_mon 59, CHARMELEON
	tr_mon 62, MAGMAR
	end_trainer

	def_trainer LOUIS, "Corey"
	tr_mon 62, ARCANINE
	tr_mon 62, RAPIDASH
	end_trainer
...
ScientistGroup:
	...
	def_trainer LOWELL, "Louis"
	tr_mon 60, ARCANINE
	end_trainer

	def_trainer DENNETT, "Looker"
	tr_mon 60, NINETALES
	end_trainer

	def_trainer LINDEN, "Lowell"
	tr_mon 60, MAGMAR
	end_trainer

	def_trainer OSKAR, "Dennett"
	tr_mon 64, PORYGON2
	tr_mon 62, NINETALES
	tr_mon 60, MAGNEZONE
	end_trainer

	def_trainer BRAYDON, "Linden"
	tr_mon 60, MAGNETON
	tr_mon 62, MAGNEZONE
	tr_mon 63, ELECTRODE
	end_trainer

	def_trainer CARL, "Oskar"
	tr_mon LEVEL_FROM_BADGES + 5, PORYGON
	tr_mon LEVEL_FROM_BADGES + 5, PORYGON
	tr_mon LEVEL_FROM_BADGES + 6, MAGNETON
	end_trainer

	def_trainer DEXTER, "Braydon"
	tr_mon 54, MAGNETON
	tr_mon 55, ALAKAZAM
	end_trainer

	def_trainer JOSEPH, "Carl"
	tr_mon 54, DITTO
	tr_mon 55, GOLDUCK
	tr_mon 53, KADABRA
	end_trainer

	def_trainer NIGEL, "Dexter"
	tr_mon 54, ELECTABUZZ
	tr_mon 55, LANTURN
	end_trainer

	def_trainer PIOTR, "Joseph"
	tr_mon 54, GOLDUCK
	tr_mon 55, ALAKAZAM
	end_trainer

	def_trainer SANDERS, "Nigel"
	tr_mon 52, ALAKAZAM
	tr_mon 54, LAPRAS
	tr_mon 53, NOCTOWL
	end_trainer
...
RocketScientistGroup:
	...
	def_trainer ROSS, "Piotr"
	tr_mon 30, KOFFING, MALE
	tr_mon 30, GRIMER, MALE | ALOLAN_FORM
	end_trainer

	def_trainer MITCH, "Sanders"
	tr_mon 25, DITTO
	tr_mon 25, PORYGON
	end_trainer

	def_trainer JED, "Ross"
	tr_mon 29, MAGNEMITE
	tr_mon 30, MAGNETON
	tr_mon 29, MAGNEMITE
	end_trainer

	def_trainer MARC, "Sanders" ; MISMATCH
	tr_mon 35, MAGNETON
	tr_mon 36, MAGNEMITE
	tr_mon 35, MAGNETON
	end_trainer

	def_trainer RICH, "Jed" ; MISMATCH
	tr_mon 35, PORYGON_Z
...
BoarderGroup:
	...
	def_trainer RONALD, "Garrett"
	tr_mon 33, SEEL
	tr_mon 35, DEWGONG
	tr_mon 33, SNEASEL
	end_trainer

	def_trainer BRAD, "Trenton"
	tr_mon 35, SWINUB
	tr_mon 35, SWINUB
	end_trainer

	def_trainer DOUGLAS, "Ronald"
	tr_mon 33, SHELLDER
	tr_mon 35, CLOYSTER
	tr_mon 33, SHELLDER
	end_trainer

	def_trainer SHAUN, "Brad"
	tr_mon 65, CLOYSTER
	tr_mon 60, DEWGONG
	end_trainer

	def_trainer BRYCE, "Douglas"
	tr_mon 65, DEWGONG
	tr_mon 60, LAPRAS
	end_trainer

	def_trainer STEFAN, "Shaun"
	tr_mon 36, SWINUB
	tr_mon 36, PILOSWINE
	tr_mon 38, SNEASEL
	end_trainer

	def_trainer MAX, "Bryce"
...
SkierGroup:
	...
	def_trainer ROXANNE, "Stefan"
	tr_mon 36, JYNX
	end_trainer

	def_trainer CLARISSA, "Max"
	tr_mon 36, PILOSWINE
	end_trainer

	def_trainer CADY, "Roxanne"
	tr_mon 63, MAMOSWINE
	end_trainer

	def_trainer MARIA, "Clarissa"
	tr_mon 39, JYNX
	end_trainer

	def_trainer BECKY, "Cady"
...
BlackbeltGroup:
	...
	def_trainer KENJI1, "Becky"
	tr_mon 39, MACHOKE
	end_trainer

;	; unused
;	def_trainer KENJI2, "Becky"
;	tr_mon 36, ONIX
;	tr_mon 38, HITMONLEE
;	tr_mon 36, ONIX
;	tr_mon 39, MACHOKE
...
;	end_trainer
	...
	def_trainer INIGO, "Lung"
	tr_mon 59, PRIMEAPE
	tr_mon 59, PRIMEAPE
	tr_mon 60, MACHAMP
	end_trainer

	def_trainer MANFORD, "Wai"
	tr_mon 63, POLIWRATH
	end_trainer

	def_trainer ANDER, "Inigo"
	tr_mon 61, PRIMEAPE
	tr_mon 57, GRAVELER
	tr_mon 62, MACHOKE
	end_trainer

	def_trainer TAKEO, "Manford"
	tr_mon 52, HITMONTOP
	tr_mon 54, HERACROSS
	tr_mon 56, POLIWRATH
	end_trainer

	def_trainer RYLAN, "Ander"
	tr_mon 54, MAGMORTAR
	tr_mon 52, ARCANINE
	tr_mon 53, HOUNDOOM
	end_trainer
...
DragonTamerGroup:
	...
	def_trainer PAUL, "Emy"
	tr_mon 37, DRATINI
	tr_mon 37, DRATINI
	tr_mon 38, DRAGONAIR
	end_trainer

	def_trainer DARIN, "Sasha"
	tr_mon 38, DRAGONAIR
	...
	def_trainer ADAM, "Paul"
	tr_mon 37, YANMA
	tr_mon 38, SEADRA
	tr_mon 39, DRATINI
	end_trainer

	def_trainer ERICK, "Darin"
	tr_mon 39, DRAGONAIR
...
EngineerGroup:
	...
	def_trainer SMITH, "Kazu"
	tr_mon 58, MAGNETON
	tr_mon 60, MAGNEZONE
	end_trainer

	def_trainer BERNIE, "Aegon"
	tr_mon 54, MAGNEMITE
	tr_mon 56, MAGNETON
	tr_mon 54, MAGNEMITE
	end_trainer

	def_trainer CAMDEN, "Smith"
	tr_mon 56, MAGNETON
	tr_mon 56, ELECTRODE
	end_trainer

	def_trainer LANG, "Bernie"
	tr_mon 55, ELECTRODE
	tr_mon 55, ELECTRODE
	end_trainer

	def_trainer HUGO, "Camden"
	tr_mon 54, MAGNETON
	tr_mon 56, STEELIX
	end_trainer

	def_trainer HOWARD, "Lang"
	tr_mon 57, MAGNEZONE
	end_trainer

	def_trainer GRADEN, "Hugo"
...
TeacherFGroup:
	...
	def_trainer COLETTE, "Gustav"
	tr_mon 60, CLEFAIRY
	end_trainer

	def_trainer HILLARY, "Nicolas"
	tr_mon 58, AIPOM
	tr_mon 56, SUNFLORA
	tr_mon 59, MAROWAK
	end_trainer

	def_trainer SHIRLEY, "Colette"
	tr_mon 47, WIGGLYTUFF
	end_trainer

	def_trainer KATHRYN, "Hillary"
	tr_mon LEVEL_FROM_BADGES + 5, BELLOSSOM
	tr_mon LEVEL_FROM_BADGES + 3, PIDGEOTTO
	tr_mon LEVEL_FROM_BADGES + 2, FURRET
	end_trainer

	def_trainer CLARICE, "Shirley"
	tr_mon 54, FURRET
	tr_mon 56, SUNFLORA
	end_trainer

	def_trainer SERENA, "Kathryn"
	tr_mon 55, UMBREON
	tr_mon 52, VAPOREON
	tr_mon 54, ESPEON
	end_trainer
...
GuitaristMGroup:
	...
	def_trainer CLYDE, "Serena"
	tr_mon 50, ELECTABUZZ
	end_trainer

	def_trainer VINCENT, "Nolan"
	tr_mon 53, VOLTORB
	tr_mon 52, MAGNEMITE
	tr_mon 55, JOLTEON
	end_trainer

	def_trainer ROGER, "Clyde"
	tr_mon 56, RAICHU
	tr_mon 58, ELECTABUZZ
	end_trainer

	def_trainer EZEKIEL, "Vincent"
	tr_mon 56, MAGNEZONE
	end_trainer

	def_trainer BIFF, "Roger"
	tr_mon 52, ONIX
	tr_mon 54, MAGNETON
	tr_mon 56, SKARMORY
	end_trainer

	def_trainer GEDDY, "Ezekiel"
	tr_mon 50, BULBASAUR
	end_trainer
...
GuitaristFGroup:
	...
	def_trainer MORGAN, "Geddy"
	tr_mon 55, ELECTRODE
	tr_mon 55, JOLTEON
	end_trainer

	def_trainer RITSUKO, "Janet"
	tr_mon 56, JOLTEON
	tr_mon 58, JOLTEON
	end_trainer

	def_trainer WANDA, "Morgan"
	tr_mon 53, MAGNEMITE
	tr_mon 54, ELECTRODE
	tr_mon 55, MAGNETON
	end_trainer

	def_trainer JACLYN, "Ritsuko"
	tr_mon 56, ELECTIVIRE
	end_trainer
...
BikerGroup:
	...
	def_trainer HARRIS, "Jaclyn"
	tr_mon 57, FLAREON
	end_trainer

	def_trainer ZEKE, "Dwayne"
	tr_mon 55, KOFFING
	tr_mon 56, WEEZING
	end_trainer

	def_trainer CHARLES, "Harris"
	tr_mon 54, KOFFING
	tr_mon 54, CHARMELEON
	tr_mon 57, WEEZING
	end_trainer

	def_trainer REILLY, "Zeke"
	tr_mon 59, WEEZING
	end_trainer

	def_trainer JOEL, "Charles"
	tr_mon 57, MAGMAR
	tr_mon 57, MAGMAR
	end_trainer

	def_trainer GLENN, "Reilly"
	tr_mon 55, KOFFING
	tr_mon 57, MAGMAR
	tr_mon 59, WEEZING
	end_trainer

	def_trainer DALE, "Joel"
	tr_mon 57, MUK
	tr_mon 57, WEEZING
	end_trainer

	def_trainer JACOB, "Glenn"
	tr_mon 54, MAGMAR
	tr_mon 54, TENTACRUEL
	end_trainer

	def_trainer AIDEN, "Dale"
	tr_mon 55, URSARING
	tr_mon 55, AZUMARILL
	end_trainer

	def_trainer DAN, "Jacob"
	tr_mon 57, MUK
	tr_mon 55, WEEZING
	tr_mon 55, WEEZING
	end_trainer

	def_trainer TEDDY, "Aiden"
	tr_mon 58, ARBOK
	end_trainer

	def_trainer TYRONE, "Jacob"
	tr_mon 22, TYROGUE
	tr_mon 32, GRIMER
	tr_mon 42, MUK
	tr_mon 52, WEEZING
...
RoughneckGroup:
	...
	def_trainer BRIAN, "Teddy"
	tr_mon 55, TENTACRUEL
	tr_mon 55, WEEZING
	tr_mon 55, WEEZING
	end_trainer

	def_trainer THERON, "Tyrone"
	tr_mon 55, MUK
	tr_mon 55, POLIWRATH
	end_trainer

	def_trainer MARKEY, "Brian"
	tr_mon 57, ARBOK
	tr_mon 56, HOUNDOOM
	end_trainer
...
AromaLadyGroup:
	...
	def_trainer DAHLIA, "Marlene"
	tr_mon 58, VILEPLUME
	tr_mon 58, BELLOSSOM
	end_trainer

	def_trainer BRYONY, "Rin"
	tr_mon 55, BELLOSSOM
	...
	def_trainer HEATHER, "Dahlia"
	tr_mon 35, CHIKORITA
	tr_mon 45, BAYLEEF
	tr_mon 55, MEGANIUM
	end_trainer

	def_trainer HOLLY, "Begonia"
	tr_mon 62, SUNFLORA
	tr_mon 62, SUNFLORA
	end_trainer

	def_trainer PEONY, "Heather"
	tr_mon 50, BULBASAUR
	end_trainer
...
SightseerMGroup:
	...
	def_trainer JASKA, "Holly"
	tr_mon 50, BULBASAUR
	end_trainer

	def_trainer BLAISE, "Peony"
	tr_mon 50, "Bulbasaur", BULBASAUR, MALE
	end_trainer

	def_trainer GARETH, "Jaska"
	tr_mon 50, BULBASAUR
	end_trainer

	def_trainer CHESTER, "Blaise"
	tr_mon 50, BULBASAUR
	end_trainer

	def_trainer HARI, "Gareth"
	tr_mon 50, BULBASAUR
	end_trainer
...
SightseerFGroup:
	...
	def_trainer ROSIE, "Chester"
	tr_mon 50, BULBASAUR
	end_trainer

	def_trainer KAMILA, "Hari"
	tr_mon 50, BULBASAUR
	end_trainer

	def_trainer NOELLE, "Flora"
	tr_mon 50, BULBASAUR
	end_trainer

	def_trainer PILAR, "Kamila"
...
SightseersGroup:
	...
	def_trainer LIANDSU1, "Lenie"
	tr_mon 54, MAGMORTAR, MALE
	tr_mon 54, ELECTIVIRE, FEMALE
	end_trainer

	def_trainer LIANDSU2, "Lenie"
	tr_mon 54, ELECTIVIRE, FEMALE
	tr_mon 54, MAGMORTAR, MALE
	end_trainer

	def_trainer CYANDVI1, "Li & Su"
	tr_mon 64, MR__MIME, MALE
	tr_mon 64, JYNX, FEMALE
	end_trainer

	def_trainer CYANDVI2, "Li & Su"
	tr_mon 64, JYNX, FEMALE
	tr_mon 64, MR__MIME, MALE
	end_trainer
...
CooltrainerMGroup:
	...
	def_trainer AARON, "Gaven"
	tr_mon 28, IVYSAUR
	tr_mon 28, CHARMELEON
	tr_mon 28, WARTORTLE
	end_trainer

	def_trainer CODY, "Nick"
	tr_mon 36, HORSEA
	tr_mon 37, SEADRA
	tr_mon 38, YANMA
	end_trainer

	def_trainer MIKE, "Aaron"
	tr_mon 38, DRAGONAIR
	end_trainer

	def_trainer RYAN, "Cody"
	tr_mon 35, PIDGEOT
	...
	def_trainer ANDY, "Ryan"
	tr_mon 10, BULBASAUR
	tr_mon 10, CHARMANDER
	tr_mon 10, SQUIRTLE
	end_trainer

	def_trainer SEAN, "Blake"
	tr_mon 47, FLAREON
	tr_mon 47, TANGELA
	tr_mon 47, TAUROS
	end_trainer

	def_trainer KEVIN, "Andy"
	tr_mon 54, RHYDON
	tr_mon 56, CHARIZARD
	tr_mon 56, BLASTOISE
	end_trainer

	def_trainer ALLEN, "Sean"
	...
	def_trainer FRENCH, "Kevin"
	tr_mon 62, HOUNDOOM
	tr_mon 63, ALAKAZAM
	end_trainer

	def_trainer HENRI, "Allen"
	tr_mon LEVEL_FROM_BADGES + 5, CHARMELEON
	tr_mon LEVEL_FROM_BADGES + 5, WARTORTLE
	tr_mon LEVEL_FROM_BADGES + 5, IVYSAUR
	end_trainer

	def_trainer CONNOR, "Kevin"
	tr_mon 63, SCYTHER
	tr_mon 62, CROCONAW
	tr_mon 62, WARTORTLE
	end_trainer

	def_trainer KIERAN, "Henri"
	tr_mon 52, HYPNO
	tr_mon 53, RHYHORN
	tr_mon 55, PRIMEAPE
	end_trainer

	def_trainer FINCH, "Connor"
	...
	def_trainer COOLTRAINERM_COREY, "Connor"
	...
	def_trainer COOLTRAINERM_RAYMOND, "Kieran" ; MISMATCH
...
endc
	...
	def_trainer REENA1, "Beth"
	tr_mon 37, ARCANINE
	tr_mon 40, NIDOQUEEN
	tr_mon 38, STARMIE
	end_trainer

	def_trainer REENA2, "Beth"
	tr_mon 41, ARCANINE
	tr_mon 44, NIDOQUEEN
	tr_mon 42, STARMIE
	end_trainer

	def_trainer REENA3, "Beth"
	tr_mon 45, ARCANINE
	...
	def_trainer LOIS, "Reena"
	tr_mon 29, JUMPLUFF
	tr_mon 29, NINETALES
	end_trainer

	def_trainer FRAN, "Gwen"
if DEF(FAITHFUL)
	tr_mon 39, SEADRA
else
	tr_mon 39, CHARIZARD
endc
	...
	def_trainer LOLA, "Lois"
	tr_mon 36, DRATINI
	tr_mon 38, DRAGONAIR
	end_trainer

	def_trainer KATE, "Fran"
	tr_mon 26, SHELLDER
	tr_mon 28, CLOYSTER
	end_trainer
	...
	def_trainer KELLY, "Kate"
	tr_mon 37, MARILL
	tr_mon 35, WARTORTLE
	tr_mon 35, CROCONAW
	end_trainer

	def_trainer JOYCE, "Irene"
	tr_mon 37, PIKACHU
	...
	def_trainer CAROL, "Joyce"
	tr_mon 47, ELECTRODE
	tr_mon 47, STARMIE
	tr_mon 47, NINETALES
	end_trainer

	def_trainer QUINN, "Megan"
	tr_mon 63, VENUSAUR
	tr_mon 62, STARMIE
	end_trainer

	def_trainer EMMA, "Carol"
	tr_mon 28, POLIWHIRL
	end_trainer

	def_trainer CYBIL, "Quinn"
	...
	def_trainer JENN, "Emma"
	tr_mon 24, STARYU
	tr_mon 26, STARMIE
	end_trainer

	def_trainer SALMA, "Cybil"
	tr_mon 62, SLOWKING
	tr_mon 65, KANGASKHAN
	end_trainer

	def_trainer BONITA, "Jenn"
	tr_mon 62, GIRAFARIG
	tr_mon 65, SUDOWOODO
	end_trainer

	def_trainer SERA, "Salma"
	tr_mon 63, CHARMELEON @ EVIOLITE
	tr_mon 61, AMPHAROS @ MAGNET
	tr_mon 61, XATU @ TWISTEDSPOON
	end_trainer

	def_trainer NEESHA, "Bonita"
...
AceDuoGroup:
	...
	def_trainer ELANANDIDA1, "Chiara"
	tr_mon 65, PORYGON2, MALE
	tr_mon 65, AZUMARILL, FEMALE
	end_trainer

	def_trainer ELANANDIDA2, "Chiara"
	tr_mon 65, AZUMARILL, FEMALE
	tr_mon 65, PORYGON2, MALE
	end_trainer

	def_trainer ARAANDBELA1, "Elan & Ida"
	tr_mon 64, TAUROS, MALE
	tr_mon 64, GIRAFARIG, FEMALE
	end_trainer

	def_trainer ARAANDBELA2, "Elan & Ida"
	tr_mon 64, GIRAFARIG, FEMALE
	tr_mon 64, TAUROS, MALE
	end_trainer

	def_trainer THOMANDKAE1, "Ara & Bela"
	tr_mon LEVEL_FROM_BADGES + 2, MAGMAR, MALE
	tr_mon LEVEL_FROM_BADGES + 2, ELECTABUZZ, FEMALE
	end_trainer

	def_trainer THOMANDKAE2, "Ara & Bela"
	tr_mon LEVEL_FROM_BADGES + 2, ELECTABUZZ, FEMALE
	tr_mon LEVEL_FROM_BADGES + 2, MAGMAR, MALE
	end_trainer

	def_trainer ZACANDJEN1, "Thom & Kae"
	tr_mon 62, DUGTRIO, MALE
	tr_mon 62, ELECTIVIRE, FEMALE
	end_trainer

	def_trainer ZACANDJEN2, "Thom & Kae"
	tr_mon 62, ELECTIVIRE, FEMALE
	tr_mon 62, DUGTRIO, MALE
	end_trainer

	def_trainer JAKEANDBRI1, "Zac & Jen"
	...
	def_trainer JAKEANDBRI2, "Zac & Jen"
	tr_mon 37, PARASECT, FEMALE
	tr_mon 39, VAPOREON, FEMALE
	tr_mon 37, SANDSLASH, MALE
	tr_mon 39, GOLDUCK, MALE
	...
	def_trainer DANANDCARA1, "Jake & Bri"
	...
	def_trainer DANANDCARA2, "Jake & Bri"
	tr_mon 38, SEADRA, FEMALE
		tr_moves SMOKESCREEN, WATER_PULSE, OUTRAGE, WHIRLPOOL
	tr_mon 38, SEADRA, MALE
		tr_moves SMOKESCREEN, WATER_PULSE, OUTRAGE, WATERFALL
...
VeteranMGroup:
	...
	def_trainer MATT, "Dan & Cara" ; MISMATCH
