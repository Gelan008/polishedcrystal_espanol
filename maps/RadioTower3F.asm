...
GenericTrainerGruntM8:
	...
	para "¡Maldita sea! ¡Qué"
	line "inútiles son mis"
	cont "#mon!"
	done
...
GenericTrainerGruntM9:
	...
	text "¡¿Qué?! ¿Superaste"
	line "a los del Pasaje"
	cont "Subterráneo?"

	para "¿Cómo has podido?"
	done
...
GenericTrainerRocketScientistMarc:
	...
	line "emitir una señal"
	cont "tan fuerte como"
	cont "quiera."
	done
