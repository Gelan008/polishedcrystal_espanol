...
GBPrinterString_PrinterError1:
	db   " Error Impresora 1"
	next ""
	next "Las pilas están"
	next "casi agotadas."
	db   "@"
GBPrinterString_PrinterError2:
	db   " Error Impresora 2"
	next ""
	next "Cable Game Link"
	next "desconectado."
	db   "@"
GBPrinterString_PrinterError3:
	db   " Error Impresora 3"
	next ""
	next "El papel se ha"
	next "atascado o falta."
	db   "@"
GBPrinterString_PrinterError4:
	db   " Error Impresora 4"
	next ""
	next "La temperatura es"
	next "muy alta o baja."
	db   "@"
